<template>
  <div class="loader-wrap">timer
    <!-- <canvas id="light-timer"></canvas> -->
    <div id="countdown-timer" @mouseenter="enter">
...
<script>
  ...
  export default {
    ...
    methods : {
      ...
      start: function() {
          this.countdownController.play(this.t),
          // this.showCurrentTime && this.logoController.play(this.t),
          this.t = !0
      }
    }
